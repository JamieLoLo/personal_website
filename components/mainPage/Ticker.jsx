...
export default function Ticker({ visible }) {
  ...
  return (
    <>
      {visible && (
        <motion.div
          className='w-[40%] h-[50px] overflow-hidden relative  text-[24px] text-ticker-100 new-amsterdam-regular'
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          >
            <div ref={tickerRef} className='flex translate-y-[8px]'>
              <p className='ml-[16px]'>
                DISCOVER MORE INSIGHTS BY FLIPPING TO THE BOTTOM & CLICK TO
                EXPLORE MY BLOG!
              </p>
              <p className='ml-[16px]'>
                DISCOVER MORE INSIGHTS BY FLIPPING TO THE BOTTOM & CLICK TO
